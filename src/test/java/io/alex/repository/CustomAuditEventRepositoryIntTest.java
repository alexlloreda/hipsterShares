...
import io.alex.config.audit.AuditEventConverter;
import io.alex.domain.PersistentAuditEvent;
...
import static io.alex.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
